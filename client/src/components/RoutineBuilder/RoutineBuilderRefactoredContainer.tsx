...
import RoutineBuilderRefactored from './RoutineBuilderRefactored';
import { 
  resetRoutineBuilder, 
  fetchRoutines, 
  attemptUpdateRoutine, 
  attemptCreateRoutine, 
  attemptDeleteRoutine, 
  fetchUsers, 
  updateUserId, 
  resetStepList, 
  resetForm, 
...
const RoutineBuilderRefactoredContainer = enhance(RoutineBuilderRefactored);

export default RoutineBuilderRefactoredContainer;